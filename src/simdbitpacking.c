...
static void SIMD_nullunpacker32(const __m128i *_in, int *out) {
  (void)_in;
  memset(out, 0, 32 * 4 * 4);
}
...
static void __SIMD_fastunpack1_32(const __m128i *in, int *_out) {
...
static void __SIMD_fastunpack2_32(const __m128i *in, int *_out) {
...
static void __SIMD_fastunpack3_32(const __m128i *in, int *_out) {
...
static void __SIMD_fastunpack4_32(const __m128i *in, int *_out) {

  __m128i *out = (__m128i *)(_out);
  __m128i InReg = _mm_loadu_si128(in); // load 0 - 8 packs
  __m128i OutReg;
  __m128i TmpReg;
  __m128i OutReg1;
  const __m128i mask = _mm_set1_epi32((1U << 4) - 1);
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
  _mm_storeu_si128(out++, OutReg1);

  OutReg = _mm_and_si128(_mm_srli_epi32(InReg, 4), mask); // 1
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
  _mm_storeu_si128(out++, OutReg1);

  OutReg = _mm_and_si128(_mm_srli_epi32(InReg, 8), mask); // 2
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
  _mm_storeu_si128(out++, OutReg1);

  OutReg = _mm_and_si128(_mm_srli_epi32(InReg, 12), mask); // 3
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
  _mm_storeu_si128(out++, OutReg1);

  OutReg = _mm_and_si128(_mm_srli_epi32(InReg, 16), mask); // 4
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
  _mm_storeu_si128(out++, OutReg1);

  OutReg = _mm_and_si128(_mm_srli_epi32(InReg, 20), mask); // 5
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
  _mm_storeu_si128(out++, OutReg1);

  OutReg = _mm_and_si128(_mm_srli_epi32(InReg, 24), mask); // 6
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
  _mm_storeu_si128(out++, OutReg1);

  OutReg = _mm_srli_epi32(InReg, 28); // 7
  TmpReg = _mm_slli_epi32(OutReg, 32-4);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-4);
...
static void __SIMD_fastunpack5_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-5);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-5);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack6_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-6);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-6);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack7_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-7);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-7);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack8_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-8);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-8);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack9_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-9);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-9);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack10_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-10);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-10);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack11_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-11);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-11);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack12_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-12);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-12);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack13_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-13);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-13);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack14_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-14);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-14);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack15_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-15);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-15);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack16_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-16);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-16);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack17_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-17);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-17);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack18_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-18);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-18);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack19_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-19);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-19);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack20_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-20);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-20);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack21_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-21);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-21);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack22_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-22);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-22);
  _mm_storeu_si128(out++, OutReg);
...
static void __SIMD_fastunpack23_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-23);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-23);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack24_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-24);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-24);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack25_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-25);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-25);
  _mm_storeu_si128(out++, OutReg);
...
static void __SIMD_fastunpack26_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-26);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-26);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack27_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-27);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-27);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack28_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-28);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-28);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack29_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-29);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-29);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack30_32(const __m128i *in, int *_out) {
  ...
  OutReg = _mm_and_si128(InReg, mask);
  TmpReg = _mm_slli_epi32(OutReg, 32-30);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-30);
  _mm_storeu_si128(out++, OutReg1);
...
static void __SIMD_fastunpack31_32(const __m128i *in, int *_out) {
  ...
  TmpReg = _mm_slli_epi32(OutReg, 32-31);
  OutReg1 = _mm_srai_epi32(TmpReg, 32-31);
  _mm_storeu_si128(out++, OutReg1);
...
void __SIMD_fastunpack32_32(const __m128i *in, int *_out) {
  __m128i *out = (__m128i *)(_out);
  uint32_t outer;
...
void simdunpack(const __m128i *in, int *out, const uint32_t bit) {
  switch (bit) {
  case 0:
